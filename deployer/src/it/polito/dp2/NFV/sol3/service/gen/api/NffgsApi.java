...
public class NffgsApi extends RestApplication {
   private final NffgsApiService delegate = NffgsApiServiceFactory.getNffgsApi();
    ...
    public Response addLink( @PathParam("nffg_id") String nffgId, @NotNull  @QueryParam("overwrite") Boolean overwrite,@ApiParam(value = "Link to be inserted" ,required=true) LinkType link,@Context SecurityContext securityContext)
    ...
    @io.swagger.annotations.ApiOperation(value = "adds a single node to the NF-FG", notes = "Adds single node in an already deployed NF-FG (it is added without links and it is also allocated on a host; if allocation is not possible, the addition of the node fails and nothing is added).", response = Void.class, tags={ "nffgs", })
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 404, message = "(NF-FG) Not found", response = Void.class) })
    public Response addNode( @PathParam("nffg_id") String nffgId,@ApiParam(value = "Node to be inserted" ,required=true) NodeType node,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @io.swagger.annotations.ApiOperation(value = "removes a single link", notes = "Removes a single link in an already deployed NF-FG", response = Void.class, tags={ "nffgs", })
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    public Response deleteLink( @PathParam("nffg_id") String nffgId, @PathParam("link_id") String linkId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @io.swagger.annotations.ApiOperation(value = "removes a single node", notes = "Removes a single node in an already deployed NF-FG (removal must be possible only if the node has no incoming links and no outgoing links; removing the node also removes its allocation).", response = Void.class, tags={ "nffgs", })
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    public Response deleteNode( @PathParam("nffg_id") String nffgId, @PathParam("node_id") String nodeId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @io.swagger.annotations.ApiOperation(value = "deploys a NF-FG", notes = "Deploys a new NF-FG into the system (when a new NF-FG is deployed, its nodes are allocated onto the IN hosts; if it is not possible to allocate all the NF-FG nodes, deployment fails, and nothing is added). If deployment is successful, deploy time is set to the current time.", response = Void.class, tags={ "nffgs", })
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    public Response deployNffg(@ApiParam(value = "NF-FG to be inserted" ,required=true) NffgType nffg,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @Produces({ "application/xml" })
    @io.swagger.annotations.ApiOperation(value = "retrieves a single NF-FG object", notes = "Retrieves all info about the NF-FG specified in the resource path", response = NffgType.class, tags={ "nffgs", })
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    @Consumes({ "text/plain" })
    @Produces({ "application/xml" })
    @io.swagger.annotations.ApiOperation(value = "retrieves all NF-FGs", notes = "Retrieves all NF-FGs requested by end-users", response = NffgsType.class, tags={ "nffgs", })
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    @Produces({ "application/xml" })
    @io.swagger.annotations.ApiOperation(value = "retrieves all nodes from an NF-FG", notes = "Retrieves all node objects from an existing NF-FG", response = NodesType.class, tags={ "nffgs", })
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    @io.swagger.annotations.ApiOperation(value = "undeploys a NF-FG", notes = "Undeploy an NF-FG (when an NF-FG is undeployed, its allocation relationships are removed).", response = Void.class, tags={ "nffgs", })
    @io.swagger.annotations.ApiResponses(value = { 
