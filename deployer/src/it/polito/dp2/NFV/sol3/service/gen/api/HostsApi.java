...
public class HostsApi extends RestApplication {
   private final HostsApiService delegate = HostsApiServiceFactory.getHostsApi();
    ...
    @io.swagger.annotations.ApiOperation(value = "retrieves a single host object", notes = "Retrieves a single host object having the ID specified in the resource path", response = HostType.class, tags={ "hosts", })
    ...
    @Produces({ "application/xml" })
    @io.swagger.annotations.ApiOperation(value = "retrieves all physical hosts in the DP2-NFV system", notes = "Retrieves a set containing all physical IN host objects in the DP2-NFV system", response = HostsType.class, tags={ "hosts", })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "OK", response = HostsType.class) })
    public Response getHosts(@Context SecurityContext securityContext)
    throws NotFoundException {
